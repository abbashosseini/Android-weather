package com.hosseini.abbas.havakhabar.app.service;
...
public class SService extends IntentService {
    ...
    public static class AlarmReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            Intent sendIntent = new Intent(context, SService.class);
            sendIntent.putExtra(SService.LOCATION_QUERY_EXTRA, intent.getStringExtra(SService.LOCATION_QUERY_EXTRA));
